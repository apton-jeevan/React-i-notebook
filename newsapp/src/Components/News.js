...
export class News extends Component {
    ...
    fetchMoreData= async () => {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=9856e4b407c245f294e49ed3ace91c5b&page=${this.state.page +1}&pagesize={this.props.pageSize}`;
